...
use App\Repository\CmprCotacaoSituacaoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CmprCotacaoSituacaoRepository::class)]
#[ORM\Table(
    name: 'cmpr_cotacao_situacao',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class CmprCotacaoSituacao
{
    #[ORM\Id]
