...
use App\Repository\ArvoreLivroIntegracaoLogRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ArvoreLivroIntegracaoLogRepository::class)]
#[ORM\Table(
    name: 'arvore_livro_integracao_log',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class ArvoreLivroIntegracaoLog
{
    #[ORM\Id]
