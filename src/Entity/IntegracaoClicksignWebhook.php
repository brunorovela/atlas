...
use App\Repository\IntegracaoClicksignWebhookRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoClicksignWebhookRepository::class)]
#[ORM\Table(
    name: 'integracao_clicksign_webhook',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci', 'engine' => 'MyISAM']
)]
class IntegracaoClicksignWebhook
{
    #[ORM\Id]
