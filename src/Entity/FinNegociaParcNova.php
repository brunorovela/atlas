...
use App\Repository\FinNegociaParcNovaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: FinNegociaParcNovaRepository::class)]
#[ORM\Table(
    name: 'fin_negocia_parc_nova',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'IX_CD_NEGOCIA', columns: ['cd_negocia'])]
#[ORM\Index(name: 'IX_CD_MENSALIDADE', columns: ['cd_mensalidade'])]
class FinNegociaParcNova
{
    #[ORM\Id]
