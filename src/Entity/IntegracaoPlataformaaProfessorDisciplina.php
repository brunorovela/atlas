...
use App\Repository\IntegracaoPlataformaaProfessorDisciplinaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPlataformaaProfessorDisciplinaRepository::class)]
#[ORM\Table(
    name: 'integracao_plataformaa_professor_disciplina',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_integracao_plataformaa_professor_disciplina', columns: ['plataformaa_ambiente_id', 'cd_pessoa', 'ds_external_class_subject_id'])]
#[ORM\Index(name: 'integracao_plataformaa_professor_disciplina_pessoas_FK', columns: ['cd_pessoa'])]
#[ORM\Index(name: 'IDX_3BBBD9F65EAA6F8A', columns: ['plataformaa_ambiente_id'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'integracao_plataformaa_professor_disciplina_ambiente_FK', 'colunas' => ['plataformaa_ambiente_id'], 'tabelaAlvo' => 'integracao_plataformaa_ambiente', 'colunasAlvo' => ['id'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'integracao_plataformaa_professor_disciplina_pessoas_FK', 'colunas' => ['cd_pessoa'], 'tabelaAlvo' => 'pessoas', 'colunasAlvo' => ['cd_pessoa'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class IntegracaoPlataformaaProfessorDisciplina
{
    #[ORM\Id]
