...
use App\Repository\ColigadasRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ColigadasRepository::class)]
#[ORM\Table(
    name: 'coligadas',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'IX_CD_COLIGADA_MATRIZ', columns: ['CD_COLIGADA_MATRIZ'])]
#[ORM\Index(name: 'IX_SN_MATRIZ', columns: ['SN_MATRIZ'])]
...
class Coligadas
{
    ...
    #[ORM\Column(name: 'nm_coligada', type: 'string', length: 255, nullable: true)]
    ...
    #[ORM\Column(name: 'cd_pais', type: 'integer', options: ['default' => '0'])]
    private int $cdPais = 0;
    ...
    #[ORM\Column(name: 'sn_academico', type: 'smallint', nullable: true, options: ['unsigned' => true, 'default' => '1'])]
    private ?int $snAcademico = 1;

    #[ORM\Column(name: 'sn_financeiro', type: 'smallint', nullable: true, options: ['unsigned' => true, 'default' => '1'])]
    private ?int $snFinanceiro = 1;
    ...
    #[ORM\Column(name: 'SN_MATRIZ', type: 'boolean', nullable: true, options: ['default' => '0'])]
    private ?bool $snMatriz = false;
    ...
    #[ORM\Column(name: 'ds_ato_ofic_estab', type: 'string', length: 500, nullable: true)]
    private ?string $dsAtoOficEstab = null;

    #[ORM\Column(name: 'dt_base', type: 'datetime', nullable: true, options: ['default' => 'CURRENT_TIMESTAMP'])]
    private ?\DateTimeInterface $dtBase = null;

    #[ORM\Column(name: 'ds_telefone_geral', type: 'string', length: 50, nullable: true)]
    private ?string $dsTelefoneGeral = null;

    #[ORM\Column(name: 'cd_regime_apuracao', type: 'integer', nullable: true)]
    private ?int $cdRegimeApuracao = null;
    ...
    // Sem construtor: 44 propriedades. Use os setters encadeados.
    ...
    public function getSnFinanceiro(): ?int
    {
        return $this->snFinanceiro;
    }

    public function setSnFinanceiro(?int $snFinanceiro): self
    {
    ...
    public function isSnMatriz(): ?bool
    {
        return $this->snMatriz;
    }

    public function setSnMatriz(?bool $snMatriz): self
    {
        $this->snMatriz = $snMatriz;
        return $this;
    }
    ...
    public function getDsTelefoneGeral(): ?string
    {
        return $this->dsTelefoneGeral;
    }

    public function setDsTelefoneGeral(?string $dsTelefoneGeral): self
    {
        $this->dsTelefoneGeral = $dsTelefoneGeral;
        return $this;
    }

    public function getCdRegimeApuracao(): ?int
    {
        return $this->cdRegimeApuracao;
    }

    public function setCdRegimeApuracao(?int $cdRegimeApuracao): self
    {
        $this->cdRegimeApuracao = $cdRegimeApuracao;
        return $this;
    }
