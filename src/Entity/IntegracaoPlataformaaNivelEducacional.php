...
use App\Repository\IntegracaoPlataformaaNivelEducacionalRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPlataformaaNivelEducacionalRepository::class)]
#[ORM\Table(
    name: 'integracao_plataformaa_nivel_educacional',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_integracao_plataformaa_nivel_educacional', columns: ['plataformaa_ambiente_id', 'cd_situacao'])]
#[ORM\Index(name: 'IDX_CD_SITUACAO', columns: ['cd_situacao'])]
#[ORM\Index(name: 'IDX_D960BDFD5EAA6F8A', columns: ['plataformaa_ambiente_id'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'integracao_plataformaa_nivel_educacional_ambiente_FK', 'colunas' => ['plataformaa_ambiente_id'], 'tabelaAlvo' => 'integracao_plataformaa_ambiente', 'colunasAlvo' => ['id'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class IntegracaoPlataformaaNivelEducacional
{
    #[ORM\Id]
