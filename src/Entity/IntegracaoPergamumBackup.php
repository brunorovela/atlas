...
use App\Repository\IntegracaoPergamumBackupRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPergamumBackupRepository::class)]
#[ORM\Table(
    name: 'integracao_pergamum_backup',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class IntegracaoPergamumBackup
{
    #[ORM\Id]
    ...
    #[ORM\Column(name: 'tp_destino', type: 'enum', options: ['values' => ['UNIMESTRE', 'PERGAMUM']])]
    ...
    #[ORM\Column(name: 'tp_informacao', type: 'enum', options: ['values' => ['CURSO', 'TURMA', 'PESSOA', 'PROFESSOR', 'MATRICULA', 'MULTA', 'ATIVO']])]
