...
use App\Repository\AppIntegracaoDadoAgvtRiAlunoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AppIntegracaoDadoAgvtRiAlunoRepository::class)]
#[ORM\Table(
    name: 'app_integracao_dado_agvt_ri_aluno',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'idx_app_integracao_agvt_ri_aluno_integracao', columns: ['sn_integrado', 'sn_excluido'])]
#[ORM\Index(name: 'idx_app_integracao_agvt_ri_aluno_pk', columns: ['cd_rotina'])]
class AppIntegracaoDadoAgvtRiAluno
{
    #[ORM\Id]
