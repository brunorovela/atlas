...
use App\Repository\AppIntegracaoDadoCtnVendasProdutosRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AppIntegracaoDadoCtnVendasProdutosRepository::class)]
#[ORM\Table(
    name: 'app_integracao_dado_ctn_vendas_produtos',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'idx_app_integracao_ctn_vendas_produtos_controle_integracao', columns: ['sn_integrado', 'sn_excluido'])]
#[ORM\Index(name: 'idx_app_integracao_ctn_vendas_produtos_pk', columns: ['cd_venda_produto'])]
class AppIntegracaoDadoCtnVendasProdutos
{
    #[ORM\Id]
    ...
    public function setCdVendaProduto(?int $cdVendaProduto): self
    {
        $this->cdVendaProduto = $cdVendaProduto;
        return $this;
    }
