...
use App\Repository\IntegracaoPlataformaaMatriculaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPlataformaaMatriculaRepository::class)]
#[ORM\Table(
    name: 'integracao_plataformaa_matricula',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_integracao_plataformaa_matricula', columns: ['plataformaa_ambiente_id', 'id_matricula'])]
#[ORM\Index(name: 'IDX_ID_MATRICULA', columns: ['id_matricula'])]
#[ORM\Index(name: 'IDX_CF586BB85EAA6F8A', columns: ['plataformaa_ambiente_id'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'integracao_plataformaa_matricula_ambiente_FK', 'colunas' => ['plataformaa_ambiente_id'], 'tabelaAlvo' => 'integracao_plataformaa_ambiente', 'colunasAlvo' => ['id'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class IntegracaoPlataformaaMatricula
{
    #[ORM\Id]
