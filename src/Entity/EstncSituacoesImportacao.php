...
use App\Repository\EstncSituacoesImportacaoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: EstncSituacoesImportacaoRepository::class)]
#[ORM\Table(
    name: 'estnc_situacoes_importacao',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class EstncSituacoesImportacao
{
    #[ORM\Id]
