...
use App\Repository\CmprReqProdSituacaoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CmprReqProdSituacaoRepository::class)]
#[ORM\Table(
    name: 'cmpr_req_prod_situacao',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'IX_CMPR_REQ_PROD_SITUACAO_DS_CHAVE', columns: ['ds_chave'])]
class CmprReqProdSituacao
{
    #[ORM\Id]
