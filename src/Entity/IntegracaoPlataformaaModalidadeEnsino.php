...
use App\Repository\IntegracaoPlataformaaModalidadeEnsinoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPlataformaaModalidadeEnsinoRepository::class)]
#[ORM\Table(
    name: 'integracao_plataformaa_modalidade_ensino',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_integracao_plataformaa_modalidade_ensino', columns: ['plataformaa_ambiente_id', 'ds_external_id'])]
#[ORM\Index(name: 'IDX_EXTERNAL_ID', columns: ['ds_external_id'])]
#[ORM\Index(name: 'IDX_1070A4585EAA6F8A', columns: ['plataformaa_ambiente_id'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'integracao_plataformaa_modalidade_ensino_ambiente_FK', 'colunas' => ['plataformaa_ambiente_id'], 'tabelaAlvo' => 'integracao_plataformaa_ambiente', 'colunasAlvo' => ['id'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class IntegracaoPlataformaaModalidadeEnsino
{
    #[ORM\Id]
