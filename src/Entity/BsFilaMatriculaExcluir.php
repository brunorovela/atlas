...
use App\Repository\BsFilaMatriculaExcluirRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BsFilaMatriculaExcluirRepository::class)]
#[ORM\Table(
    name: 'bs_fila_matricula_excluir',
