...
use App\Repository\CenMatriculasStatusRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CenMatriculasStatusRepository::class)]
#[ORM\Table(
    name: 'cen_matriculas_status',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class CenMatriculasStatus
{
    #[ORM\Id]
    ...
    #[ORM\Column(name: 'ds_status', type: 'string', length: 255)]
