...
use App\Repository\LaplaceIntegracaoLogRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: LaplaceIntegracaoLogRepository::class)]
#[ORM\Table(
    name: 'laplace_integracao_log',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class LaplaceIntegracaoLog
{
    #[ORM\Id]
