...
use App\Repository\SicrediBoletoLogsRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SicrediBoletoLogsRepository::class)]
#[ORM\Table(
    name: 'sicredi_boleto_logs',
    options: ['charset' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci']
)]
#[ORM\Index(name: 'idx_nossonumero', columns: ['nr_nossonumero'])]
class SicrediBoletoLogs
{
    #[ORM\Id]
