...
use App\Repository\PrgModalidadeEnsinoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PrgModalidadeEnsinoRepository::class)]
#[ORM\Table(
    name: 'prg_modalidade_ensino',
    options: ['charset' => 'utf8mb4', 'collation' => 'utf8mb4_general_ci']
)]
#[ORM\UniqueConstraint(name: 'uk_ds_chave', columns: ['ds_chave'])]
class PrgModalidadeEnsino
{
    #[ORM\Id]
