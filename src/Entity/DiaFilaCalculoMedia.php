...
use App\Repository\DiaFilaCalculoMediaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: DiaFilaCalculoMediaRepository::class)]
#[ORM\Table(
    name: 'dia_fila_calculo_media',
...
#[ORM\Index(name: 'FK_dia_fila_calculo_media_disciplinas', columns: ['cd_disciplina'])]
#[ORM\Index(name: 'FK_dia_fila_calculo_media_pessoas', columns: ['cd_pessoa'])]
#[ORM\Index(name: 'FK_dia_fila_calculo_media_pessoas_2', columns: ['cd_pessoa_logada'])]
#[ORM\Index(name: 'IDX_A6BB2D915447445E', columns: ['cd_turma'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'FK_dia_fila_calculo_media_disciplinas', 'colunas' => ['cd_disciplina'], 'tabelaAlvo' => 'disciplinas', 'colunasAlvo' => ['codigo'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'FK_dia_fila_calculo_media_pessoas', 'colunas' => ['cd_pessoa'], 'tabelaAlvo' => 'pessoas', 'colunasAlvo' => ['cd_pessoa'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'FK_dia_fila_calculo_media_pessoas_2', 'colunas' => ['cd_pessoa_logada'], 'tabelaAlvo' => 'pessoas', 'colunasAlvo' => ['cd_pessoa'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'FK_dia_fila_calculo_media_turmas', 'colunas' => ['cd_turma'], 'tabelaAlvo' => 'turmas', 'colunasAlvo' => ['codigo'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class DiaFilaCalculoMedia
{
    #[ORM\Id]
