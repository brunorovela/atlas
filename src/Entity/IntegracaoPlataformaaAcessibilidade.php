...
use App\Repository\IntegracaoPlataformaaAcessibilidadeRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPlataformaaAcessibilidadeRepository::class)]
#[ORM\Table(
    name: 'integracao_plataformaa_acessibilidade',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_integracao_plataformaa_acessibilidade', columns: ['plataformaa_ambiente_id', 'cd_situacao'])]
#[ORM\Index(name: 'IDX_CD_SITUACAO', columns: ['cd_situacao'])]
#[ORM\Index(name: 'IDX_50A55A895EAA6F8A', columns: ['plataformaa_ambiente_id'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'integracao_plataformaa_acessibilidade_ambiente_FK', 'colunas' => ['plataformaa_ambiente_id'], 'tabelaAlvo' => 'integracao_plataformaa_ambiente', 'colunasAlvo' => ['id'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class IntegracaoPlataformaaAcessibilidade
{
    #[ORM\Id]
