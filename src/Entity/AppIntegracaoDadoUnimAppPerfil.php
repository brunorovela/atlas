...
use App\Repository\AppIntegracaoDadoUnimAppPerfilRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AppIntegracaoDadoUnimAppPerfilRepository::class)]
#[ORM\Table(
    name: 'app_integracao_dado_unim_app_perfil',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'idx_app_integracao_unim_app_perfil_integracao', columns: ['sn_integrado', 'sn_excluido'])]
#[ORM\Index(name: 'idx_app_integracao_unim_app_perfil_pk', columns: ['cd_app_perfil'])]
class AppIntegracaoDadoUnimAppPerfil
{
    #[ORM\Id]
