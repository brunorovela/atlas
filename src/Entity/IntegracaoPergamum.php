...
use App\Repository\IntegracaoPergamumRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPergamumRepository::class)]
#[ORM\Table(
    name: 'integracao_pergamum',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class IntegracaoPergamum
{
    #[ORM\Id]
