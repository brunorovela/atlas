...
use App\Repository\AppIntegracaoDadoCtnMovimentacaoCreditoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AppIntegracaoDadoCtnMovimentacaoCreditoRepository::class)]
#[ORM\Table(
    name: 'app_integracao_dado_ctn_movimentacao_credito',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'idx_app_integracao_ctn_movimentacao_credito_controle_integracao', columns: ['sn_integrado', 'sn_excluido'])]
#[ORM\Index(name: 'idx_app_integracao_ctn_movimentacao_credito_pk', columns: ['cd_pessoa'])]
class AppIntegracaoDadoCtnMovimentacaoCredito
{
    #[ORM\Id]
