...
use App\Repository\PintProvasPessoasRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PintProvasPessoasRepository::class)]
#[ORM\Table(
    name: 'pint_provas_pessoas',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_PROVAS_PESSOAS_PROVA_PESSOA', columns: ['cd_prova', 'cd_pessoa'])]
#[ORM\Index(name: 'IX_CD_PESSOA', columns: ['cd_pessoa'])]
#[ORM\Index(name: 'IX_CD_PROVA', columns: ['cd_prova'])]
class PintProvasPessoas
{
    #[ORM\Id]
