...
use App\Repository\AvlResultadosOrdensRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AvlResultadosOrdensRepository::class)]
#[ORM\Table(
    name: 'avl_resultados_ordens',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci', 'comment' => 'Ordem das informa??es a serem apresenatadas (gr?f, tab, etc)']
)]
#[ORM\UniqueConstraint(name: 'cd_ordem', columns: ['cd_ordem'])]
#[ORM\Index(name: 'IX_CD_RESULTADO', columns: ['cd_resultado'])]
class AvlResultadosOrdens
{
    #[ORM\Id]
    #[ORM\GeneratedValue(strategy: 'AUTO')]
    #[ORM\Column(name: 'cd_ordem', type: 'integer')]
