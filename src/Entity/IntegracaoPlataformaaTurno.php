...
use App\Repository\IntegracaoPlataformaaTurnoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoPlataformaaTurnoRepository::class)]
#[ORM\Table(
    name: 'integracao_plataformaa_turno',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_integracao_plataformaa_turno', columns: ['plataformaa_ambiente_id', 'ds_external_id'])]
#[ORM\Index(name: 'IDX_EXTERNAL_ID', columns: ['ds_external_id'])]
#[ORM\Index(name: 'IDX_F17B82335EAA6F8A', columns: ['plataformaa_ambiente_id'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'integracao_plataformaa_turno_ambiente_FK', 'colunas' => ['plataformaa_ambiente_id'], 'tabelaAlvo' => 'integracao_plataformaa_ambiente', 'colunasAlvo' => ['id'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class IntegracaoPlataformaaTurno
{
    #[ORM\Id]
