...
use App\Repository\DiarioProvasNotDeferimentosRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: DiarioProvasNotDeferimentosRepository::class)]
#[ORM\Table(
    name: 'diario_provas_not_deferimentos',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class DiarioProvasNotDeferimentos
{
    #[ORM\Id]
