...
use App\Repository\CursosTurmasCadastroRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CursosTurmasCadastroRepository::class)]
#[ORM\Table(
    name: 'cursos_turmas_cadastro',
...
class CursosTurmasCadastro
{
    ...
    #[ORM\Id]
    #[ORM\Column(name: 'cd_polo', type: 'smallint', options: ['default' => '0'])]
