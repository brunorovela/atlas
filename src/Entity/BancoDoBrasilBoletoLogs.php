...
use App\Repository\BancoDoBrasilBoletoLogsRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BancoDoBrasilBoletoLogsRepository::class)]
#[ORM\Table(
    name: 'banco_do_brasil_boleto_logs',
    options: ['charset' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci']
)]
#[ORM\Index(name: 'idx_nossonumero', columns: ['nr_nossonumero'])]
class BancoDoBrasilBoletoLogs
{
    #[ORM\Id]
