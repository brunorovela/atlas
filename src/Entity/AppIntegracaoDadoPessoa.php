...
use App\Repository\AppIntegracaoDadoPessoaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AppIntegracaoDadoPessoaRepository::class)]
#[ORM\Table(
    name: 'app_integracao_dado_pessoa',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'idx_app_integracao_pessoa_sn_integrado_sn_excluido', columns: ['sn_integrado', 'sn_excluido'])]
#[ORM\Index(name: 'idx_app_integracao_pessoa_cd_pessoa', columns: ['cd_pessoa'])]
class AppIntegracaoDadoPessoa
{
    #[ORM\Id]
