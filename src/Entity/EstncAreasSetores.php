...
use App\Repository\EstncAreasSetoresRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: EstncAreasSetoresRepository::class)]
#[ORM\Table(
    name: 'estnc_areas_setores',
...
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'FK_NC_AREAS_SETORES_AREAS', 'colunas' => ['cd_area'], 'tabelaAlvo' => 'estnc_areas', 'colunasAlvo' => ['cd_area'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'FK_NC_AREAS_SETORES_CD_SETOR', 'colunas' => ['cd_setor'], 'tabelaAlvo' => 'estnc_setores', 'colunasAlvo' => ['cd_setor'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class EstncAreasSetores
{
    #[ORM\Id]
