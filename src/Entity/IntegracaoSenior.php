...
use App\Repository\IntegracaoSeniorRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IntegracaoSeniorRepository::class)]
#[ORM\Table(
    name: 'integracao_senior',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class IntegracaoSenior
{
    #[ORM\Id]
    ...
    #[ORM\Column(name: 'sn_erro', type: TinyIntType::NAME, nullable: true, options: ['default' => '0'])]
    private ?int $snErro = 0;
    ...
    public function getSnErro(): ?int
    {
        return $this->snErro;
    }

    public function setSnErro(?int $snErro): self
    {
        $this->snErro = $snErro;
        return $this;
    }
