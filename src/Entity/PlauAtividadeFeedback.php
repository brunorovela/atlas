...
use App\Repository\PlauAtividadeFeedbackRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PlauAtividadeFeedbackRepository::class)]
#[ORM\Table(
    name: 'plau_atividade_feedback',
...
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'plau_atividade_feedback_ibfk_1', 'colunas' => ['cd_pessoa'], 'tabelaAlvo' => 'pessoas', 'colunasAlvo' => ['cd_pessoa'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'plau_atividade_feedback_ibfk_2', 'colunas' => ['cd_atividade'], 'tabelaAlvo' => 'plau_atividade', 'colunasAlvo' => ['cd_atividade'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'plau_atividade_feedback_ibfk_3', 'colunas' => ['cd_prioridade'], 'tabelaAlvo' => 'plau_feedb_prioridade', 'colunasAlvo' => ['cd_prioridade'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']],
        ['nome' => 'plau_atividade_feedback_ibfk_4', 'colunas' => ['cd_situacao'], 'tabelaAlvo' => 'plau_situacao', 'colunasAlvo' => ['cd_situacao'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class PlauAtividadeFeedback
{
    #[ORM\Id]
