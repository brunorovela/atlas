...
use App\Repository\BibInventariosSituacoesRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BibInventariosSituacoesRepository::class)]
#[ORM\Table(
    name: 'bib_inventarios_situacoes',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
class BibInventariosSituacoes
{
    #[ORM\Id]
