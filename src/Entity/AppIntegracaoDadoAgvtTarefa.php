...
use App\Repository\AppIntegracaoDadoAgvtTarefaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AppIntegracaoDadoAgvtTarefaRepository::class)]
#[ORM\Table(
    name: 'app_integracao_dado_agvt_tarefa',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'idx_app_integracao_agvt_tarefa_integracao', columns: ['sn_integrado', 'sn_excluido'])]
#[ORM\Index(name: 'idx_app_integracao_agvt_tarefa_pk', columns: ['cd_tarefa'])]
class AppIntegracaoDadoAgvtTarefa
{
    #[ORM\Id]
    #[ORM\Column(name: 'cd_tarefa', type: 'integer', options: ['unsigned' => true])]
