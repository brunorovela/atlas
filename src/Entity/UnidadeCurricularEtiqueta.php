...
use App\Repository\UnidadeCurricularEtiquetaRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: UnidadeCurricularEtiquetaRepository::class)]
#[ORM\Table(
    name: 'unidade_curricular_etiqueta',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'UK_NOME', columns: ['ds_nome'])]
#[ORM\UniqueConstraint(name: 'UK_SIGLA', columns: ['ds_sigla'])]
class UnidadeCurricularEtiqueta
{
    #[ORM\Id]
