...
use App\Repository\BibModalidadesMovimentoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BibModalidadesMovimentoRepository::class)]
#[ORM\Table(
    name: 'bib_modalidades_movimento',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\Index(name: 'IX_DS_SIGLA', columns: ['ds_sigla'])]
#[ORM\Index(name: 'FK_bib_modalidades_movimento_coligadas_matriz', columns: ['cd_coligada_matriz'])]
#[EsquemaFisico(
    chavesEstrangeiras: [
        ['nome' => 'FK_bib_modalidades_movimento_coligadas_matriz', 'colunas' => ['cd_coligada_matriz'], 'tabelaAlvo' => 'coligadas_matriz', 'colunasAlvo' => ['cd_coligada'], 'opcoes' => ['onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION']]
    ],
    autoIncremento: []
)]
class BibModalidadesMovimento
{
    #[ORM\Id]
    ...
    #[ORM\Column(name: 'sn_empresta_reservados', type: TinyIntType::NAME, nullable: true, options: ['unsigned' => true])]
    private ?int $snEmprestaReservados = null;
    ...
    #[ORM\Column(name: 'tm_hora_emprestimo_inicio', type: 'time', nullable: true)]
    private ?\DateTimeInterface $tmHoraEmprestimoInicio = null;

    #[ORM\Column(name: 'tm_hora_emprestimo_fim', type: 'time', nullable: true)]
    private ?\DateTimeInterface $tmHoraEmprestimoFim = null;

    #[ORM\Column(name: 'sn_disponivel', type: 'integer', nullable: true, options: ['default' => '1'])]
    ...
    public function getTmHoraEmprestimoInicio(): ?\DateTimeInterface
    {
        return $this->tmHoraEmprestimoInicio;
    }

    public function setTmHoraEmprestimoInicio(?\DateTimeInterface $tmHoraEmprestimoInicio): self
    {
        $this->tmHoraEmprestimoInicio = $tmHoraEmprestimoInicio;
        return $this;
    }

    public function getTmHoraEmprestimoFim(): ?\DateTimeInterface
    {
        return $this->tmHoraEmprestimoFim;
    }

    public function setTmHoraEmprestimoFim(?\DateTimeInterface $tmHoraEmprestimoFim): self
    {
        $this->tmHoraEmprestimoFim = $tmHoraEmprestimoFim;
        return $this;
    }
