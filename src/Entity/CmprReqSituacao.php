...
use App\Repository\CmprReqSituacaoRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CmprReqSituacaoRepository::class)]
#[ORM\Table(
    name: 'cmpr_req_situacao',
    options: ['charset' => 'latin1', 'collation' => 'latin1_swedish_ci']
)]
#[ORM\UniqueConstraint(name: 'IX_CMPR_REQ_SITUACAO_DS_CHAVE', columns: ['ds_chave'])]
class CmprReqSituacao
{
    #[ORM\Id]
